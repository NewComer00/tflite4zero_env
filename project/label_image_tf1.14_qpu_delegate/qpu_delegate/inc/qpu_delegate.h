...
#ifndef TENSORFLOW_LITE_DELEGATES_UTILS_QPU_DELEGATE_QPU_DELEGATE_H_
#define TENSORFLOW_LITE_DELEGATES_UTILS_QPU_DELEGATE_QPU_DELEGATE_H_
...
TfLiteQPUDelegateCreateUnique(const QPUDelegateOptions *options)
{
  return std::unique_ptr<TfLiteDelegate, void (*)(TfLiteDelegate *)>(
      TfLiteQPUDelegateCreate(options), TfLiteQPUDelegateDelete);
}

#endif // TENSORFLOW_LITE_DELEGATES_UTILS_QPU_DELEGATE_QPU_DELEGATE_H_
